...
const HowItWorks = () => {
  return (
    <section className="w-full bg-[#003311] py-16 md:px-6 text-white">
      <h1 className="px-4 md:px-1 text-center font-Manrope font-bold text-[2rem] md:text-[2.8rem] leading-tight md:leading-snug">
      ...
      <div className="w-full flex justify-between gap-2 md:gap-0 items-center mt-10 px-6 md:px-20">
        ...
        <div className="basis-[25%] md:basis-[20%]">
          <img src={phone5} alt="Picture 3" loading="lazy" />
        </div>
      </div>
    </section>
  );
